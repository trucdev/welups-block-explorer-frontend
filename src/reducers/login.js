...
export function loginReducer(state = { type: LOGIN_NONE, status: "", message: "", description: "", token: "", id: "", email: "", code: "", password: ""}, action) {    
    switch (action.type) {
        case LOGIN_NONE:
        ...
        case LOGIN_SUCCESS:
            ...
            break;
        case LOGIN_FAIL:
            state = { type: action.type, code: action.payload.code ,password: action.payload.password, status: LOGIN_FAIL, message: "failed", description: "user or password invalid", token: "", email: action.payload.email, id:""} 
            break;
