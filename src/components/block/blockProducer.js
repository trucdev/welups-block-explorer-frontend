  ...
  render() {
    ...
    return (
      <TableRow>
        ...
        <td>
          <div>
            <StyledLink to={'/account/' + producer_hash} target="_blank">
              {producer_name ? producer_name : producer_hash}
            </StyledLink>
            <CopyToClipboard text={producer_name ? producer_name : producer_hash}>
              <CopyOutlined />
            </CopyToClipboard>
          </div>
        </td>
