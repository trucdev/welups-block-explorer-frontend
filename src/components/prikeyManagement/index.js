	...
	columns = [
		...
		},
		{
			...
			render: (value, item, index) => {
					return  <Row>
								<Col>
									<Button type="primary" onClick={(e)=>this.onDelete(e, index)}>Delete</Button>
								</Col>
								<Col span={1}></Col>
...
export default connect(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(PriKeyManagement);